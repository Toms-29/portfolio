            ...
            <main className={lightTheme ? mainStyles.lightmode : mainStyles.darkmode}>
                <section className='w-11/12 md:w-3/4 flex flex-col items-center gap-5 '>
                    ...
                    <article className='flex flex-col justify-center tracking-wider w-11/12 h-screen'>
                        <p className={`${lightTheme ? '' : parrafoStyles.darkmode} max-w-lg shadow-lg rounded-md bg-slate-50 px-5 py-2`}>
                        ...
                        <br />
                        <p className={`${lightTheme ? '' : parrafoStyles.darkmode} max-w-lg self-end shadow-lg rounded-md bg-slate-50 px-5 py-2`}>
                    ...
                    {/* Tecnologias */}
                    <article className={`${lightTheme ? '' : articleTecnoligisStyles.darkmode} flex flex-col justify-evenly w-11/12 h-screen bg-yellow-200`}>
                        <h2 className='text-center text-6xl'>Tecnologias:</h2>
                        <section className='flex justify-around'>
                            <div className='flex flex-col gap-5'>
                                <p className={`${lightTheme ? '' : parrafoStyles.darkmode} max-w-md max-h-max rounded-md bg-slate-50 shadow-lg px-4 py-2`}>
                            ...
                            <div className={`${lightTheme ? '' : parrafoStyles.darkmode} flex items-center gap-3 justify-center flex-wrap max-w-md rounded-md bg-slate-50 shadow-lg py-5`}>
